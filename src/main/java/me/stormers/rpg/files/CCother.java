...
public class CCother {
    ...
    public static void setup(){
        ...
        fileMagic = new File(Bukkit.getServer().getPluginManager().getPlugin("RPG").getDataFolder(), "others.yml");
    ...
    public static void save(){
        try {
            ...
            System.out.println("Couldn´t save your file (other.yml)");
        }
