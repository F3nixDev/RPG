...
public class CClists {
    ...
    public static void setup(){
        ...
        fileLists = new File(Bukkit.getServer().getPluginManager().getPlugin("RPG").getDataFolder(), "lists.yml");
    ...
    public static void save(){
        try {
            ...
            System.out.println("Couldn´t save your file (Lists.yml)");
        }
